...
public class SwaggerConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder()
                .title("Plate-forme d'accès au protocole standard JT/T808 du ministère")
                .contact(new Contact("Groupe d'échange de questions：906230542", "https://gitee.com/yezhihao", ""))
